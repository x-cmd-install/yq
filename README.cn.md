...
合计: **42,012** 行代码（覆盖前 5 种语言、共 **342** 个文件）。
...
- **Star**: 16,013 · **Fork**: 1,690 · **开放 issue**: 1,615 · **贡献者**: 159

## 累计统计

- **发布数**: 169 · **已合并 PR**: 548 · **开放 PR**: 51 · **已关闭 issue**: 1370 · **开放 issue**: 245 · **提交数**: 2325
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/yq.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260926.yml` · 2026-09-26T05:35:08Z._
